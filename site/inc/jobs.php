...
$jobs = $ezDb->get_results("SELECT * from jobs WHERE `status` = 1 ORDER BY `id` DESC");

$payTypes= array('h' => 'Hourly', 'd' => 'Daily','w' => 'Weekly', 'm' => 'Monthly', 'q' => 'Quarterly', 'a' => 'Annually');
$smarty->assign("qjobs", $jobs)->assign("payTypes", $payTypes);