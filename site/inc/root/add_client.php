...
if(!empty($posts->triggers) and $posts->triggers=='getProject'){
	...
	$property=$ezDb->get_row("SELECT *  FROM `projects` WHERE `name` = '$proj_name'");
...
if( !in_array( $userinfo->userrole, array('level0','level1','level2','level3','level4','level5')) and $userinfo->active==true ):
	redirect("home");
endif;
