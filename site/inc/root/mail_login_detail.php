...
try {
	...
	'<footer class="blockquote-footer">
		<p> To complete the signup process, we do require email authentication. We request that you activate your account by clicking below or copy and paste the link below: <br/>
	...
	if ($mailer->send()) :
		$fail='<div class="alert alert-success alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> <p>Login information for Client has been successfully sent.<br/>Thanks!</p></div>';
	else:
