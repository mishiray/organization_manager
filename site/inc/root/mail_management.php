...
try {
    ...
    $mailer->addAddress($mailConfig->auth["email"], "$companyName Management");

    $mailer->isHTML(true);
    $mailer->Subject = " Payroll Update ";
    $mailer->Body = '<html>
	     <head>
	      	<title>Payroll</title>
      	  ...
      	  <body>
      	  	<div class="container">
				  ...
				  <div class="card-header " style="color: #fff !important; background-color: #4268d6; padding:10px">
				    <h3>PAYROLL UPDATE</h3>
				  </div>
				  <div class="card-body">
				    <blockquote class="blockquote mb-0">
                    <h4> New Payroll has been generated for '. $month .' '. $year.' </h4>
                      	<p>
							Please login to your account to review payroll
						</p>
					  <p>
					  '.$Site['companyName'].'
					  </p>
