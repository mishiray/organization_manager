...
function sendBirthday($name, $mailto){
				...
				<div class="container">
					...
					<div class="card-body">
						...
						<h4> Dear '.ucwords($name).'</h4>
							<p>
							Our sincerest wishes from '.$Site['companyName'].' Ltd on your Birthday.  Wishing you all the best today and throughout the coming year!
							</p>
						<p>
