...
function sendBirthdayEmployee($name, $mailto){
				...
				<div class="container">
					...
					<div class="card-body">
						...
						<h4> Dear '.ucwords($name).'</h4>
							<p>
							We feel extremely thankful to have an employee like you who fits in so well with our company culture. We appreciate all your hard work and wish you all the best. Happy Birthday!</p>
						<p>
						Atobe Constructions Company
						</p>
						</blockquote>
					</div>
					</div>
